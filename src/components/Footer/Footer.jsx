...
const Footer = () => {
  ...
  return (
    <footer className={ styles.footer } id="footer">
      ...
      <div className={ styles.madeWithDiv } >
        <h2>{ t('footer.madeWith') }</h2>
        {
          madeWithLinks.map(({name, icon, url}) => {
