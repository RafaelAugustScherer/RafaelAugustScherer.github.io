...
export const APPS: Record<AppId, AppMeta> = {
  ...
  projects: { title: 'Projects', icon: FolderGit2, defaultSize: { w: 540, h: 430 }, onDesktop: true, inDock: true },
  ...
  files: { title: 'Home', icon: FolderOpen, defaultSize: { w: 500, h: 400 }, onDesktop: true, inDock: true },
